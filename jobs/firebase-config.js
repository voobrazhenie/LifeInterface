/* The jobs module talks to the same Firebase project as fitness/.
 *
 ...
 *
 * As with fitness/firebase-config.js, this is PUBLIC BY DESIGN. The apiKey is an
 ...
 */
export { firebaseConfig } from "../fitness/firebase-config.js";
